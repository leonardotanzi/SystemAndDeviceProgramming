// Lab3es1withCS.cpp: definisce il punto di ingresso dell'applicazione console.
// IN QUESTA VERSIONE SEMPLICEMENTE CON UN SEMAFORO SETTO UNA VARIABILE GLOBALE E IL MAIN VA A LEGGERLA OGNI VOLTA CHE UN THREAD LA MODIFICA
...
vecArg				*allArray;
DWORD				*startingVec;
DWORD				nT = N_THREADS, tmpTId;
CRITICAL_SECTION	s1, s2;
...
INT _tmain(INT argc, LPTSTR argv[]) {
	...
	while (1) {
		...
		PrintVector(totLen, startingVec);
...
DWORD WINAPI MergeSort(LPVOID n) {
	...
	//In questo modo i thread entrano qua uno alla volta e poi si coordinano col main per il settaggio di tmpTId
